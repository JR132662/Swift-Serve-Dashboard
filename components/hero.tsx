                ...
                <section className="relative z-10 overflow-hidden">
                    <div className="relative pt-24 md:pt-36 overflow-hidden">
                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Computing at the Edge</span>
                        ...
                        <AnimatedGroup
                            ...
                            <div className="mask-b-from-85% relative mt-8 overflow-hidden px-2 sm:mt-12 md:mt-20 w-full">
