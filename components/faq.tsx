            ...
            <div className="mx-auto max-w-5xl px-4 md:px-6">
                ...
                <div className="mt-12">
                    <Accordion
                        ...
                        {/* ProblemSolution as a featured, expanded-friendly accordion item */}
                        <AccordionItem value="problem-solution" className="border-b">
                            <AccordionTrigger cursor="pointer" className="px-6 py-4 text-lg md:text-xl font-semibold cursor-pointer">Why this problem matters — and our approach</AccordionTrigger>
                            <AccordionContent cursor="pointer">
                                <div className="cursor-pointer p-6 rounded-b-lg">
                                    <ProblemSolution />
                                </div>
                            </AccordionContent>
                        </AccordionItem>
